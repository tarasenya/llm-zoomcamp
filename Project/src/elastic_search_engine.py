...
class ElasticHybridSearcher(ElasticSearcher):
    def __init__(self, index_name: str, elastic_search_client_uri='http://localhost:9200', model_name='all-mpnet-base-v2'):
        ...
        search_query = {
            ...
            "query": {
                "script_score": {
                            ...
                            "should": [
                                {
                                    "multi_match": {
                                        "query": input_argument,
                                        "fields": ["vague^3", "vague.keyword^2", "actual^2", "actual.keyword", "combined_text^4"],
                                        "type": "best_fields",
                                        "fuzziness": "AUTO"
                                    }
                                }
                    ...
                    "script": {
                        "source": "(cosineSimilarity(params.query_vector, 'vague_embedding') + 1.0) * 0.5 + _score * 0.5",
